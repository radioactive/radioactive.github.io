...
(function() {
  ...
  throttle_combinator = function(delay, cell) {
    var expr, handle_fire, res, tto, _ref;
    tto = void 0;
    handle_fire = function() {
      if (tto != null) {
        clearTimeout(tto);
      }
      return tto = setTimeout(delay, function() {});
    };
    (function() {});
    if (arguments.length === 0) {
      res = ReactiveEval["eval"](cell);
      if ((_ref = res.monitor) != null) {
        _ref.once('fire', handle_fire);
      }
    } else {
      cell(arguments[0]);
    }
    return expr = function() {
      return cell.apply(null, arguments);
    };
  };
